 ...
 useEffect(() => {
    ...
    const onUpdate = async () => {
        ...
        // } 
            ...
            // setLoading(true)
            // const result = await register(firstname, lastname, middleName, email, selectDate, gender, mobile)
            // setLoading(false)
    ...
    return (
        <View style={style.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginHorizontal: 20 }}>
                ...
                <Text style={style.registerText}>My Profile</Text>
            ...
            <ScrollView>
                ...
                <View style={style.btnView}>
                    <Button onPress={onUpdate} btnText={"Update"} />
                </View>
